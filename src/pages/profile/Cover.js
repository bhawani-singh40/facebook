...
export default function Cover({ cover, visitor, photos }) {
  ...
  // API call 
  // Update the cover picture and create a new post
  const updateCoverPicture = async () => {
    try {
      ...
      const path = `${user.username}/cover_pictures/${formattedDate}`;
